...
@isset($propertyOption)
    @section('title', 'Редагувати вариант Властивість ' . $propertyOption->name)
@else
    @section('title', 'Створити вариант Властивість')
@endisset

@section('content')
    <div class="col-md-12">
        @isset($propertyOption)
            <h1>Редагувати варіант <b>{{ $propertyOption->name }}</b></h1>
                @else
                    <h1>Добавити варіант </h1>
                @endisset
