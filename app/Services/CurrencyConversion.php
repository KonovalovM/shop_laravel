...
class CurrencyConversion
{
    ...
    public static function getCurrencySymbol()
    {
        ...
        // Перевірка на null перед звертанням до масиву
        if (!is_null($currencyFromSession) && isset(self::$container[$currencyFromSession])) {
            $currency = self::$container[$currencyFromSession];
            return $currency->symbol;
        } else {
            // Обробка випадку, коли значення null або відсутнє в масиві
            return "DefaultSymbol"; // Замініть це значення на ваш варіант за замовчуванням
        }
    }
